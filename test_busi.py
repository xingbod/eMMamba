...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='./test_logs/Breast/'+opt.model_name+'.log', level=logging.INFO)
    ...
    for epoch in range(3):
        pth_path = './model_pth/Breast/'+str(epoch)+'/' + opt.model_name + '/' + opt.model_name + '.pth'
        ...
        ##### put data_path here #####
        data_path = '/media/Storage2/zbw/data/breast/Dataset/'+str(epoch)+'/test'
        
        ##### save_path #####
        save_path = './result_map/Breast/' + str(epoch) + '/' + opt.model_name+'/'
